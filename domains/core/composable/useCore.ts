import type { MutationNewsletterSubscribeArgs, NewsletterSubscribeResponse } from '~/graphql'
...
export const useCore = () => {
  ...
  const newsletterSubscribe = async (params: MutationNewsletterSubscribeArgs) => {
    loading.value = true
