...
<template>
  <div>
    <div v-if="isOpen || isSearchModalOpen"
              ...
              <transition enter-active-class="transform transition duration-300 ease-in-out"
                ...
                <SfDrawer ref="drawerRef" v-model="isOpen" disable-click-away placement="top"
                  ...
                  <div class="grid grid-cols-1 lg:gap-x-6 lg:grid-cols-3 lg:narrow-container lg:relative">
                    <div v-for="{ name, childs, id } in filteredCategories" :key="id"
                    ...
                    <div
                      ...
                      <NuxtImg src="/images/watch.png" alt="New in designer watches" class="object-contain" />
                    ...
                    <SfButton square size="sm" variant="tertiary" aria-label="Close navigation menu"
                      class="lg:absolute lg:right-0 lg:top-0 hover:bg-white active:bg-white" @click="close()">
