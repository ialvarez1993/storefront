...
<template>
  <div class="shadow-lg md:rounded-md md:border md:border-neutral-100" data-testid="order-summary">
    ...
    <div class="px-4 pb-4 mt-3 md:px-6 md:pb-6 md:mt-0">
      ...
      <div v-if="cart.order?.coupons" class="flex justify-between typography-text-base mb-2">
      ...
      <div v-if="cart.order?.giftCards" class="flex justify-between typography-text-base mb-4">
        <p class="flex grow pr-2">
