...
<template>
  <div>
    ...
    <div v-if="isOpen || isSearchModalOpen" class="fixed bg-black !w-screen !h-screen inset-0 top-index" />
    <header ref="menuRef"
      ...
      <div class="grid grid-cols-5 items-center justify-center lg:justify-start h-full w-full narrow-container">
        <NuxtLink to="/" aria-label="Homepage">
          <VsfLogo />
        </NuxtLink>
        <div>
          <label class="input input-bordered rounded-none flex items-center gap-2">
        ...
        <div class="flex justify-center grid-cols-2">
          <img src="/public/images/icon-contacto-header.webp" class="w-9 object-fill" />
        ...
        <div>
          <a class="flex">
            <span class="">
              <svg class="icon-account" aria-hidden="true" focusable="false" role="presentation"
                xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 18 24" fill="none">
